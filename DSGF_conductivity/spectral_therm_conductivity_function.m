function [ spectral_therm_conductivity, spectral_therm_conductivity_Lindsay ] = spectral_therm_conductivity_function( Trans, T_therm_cond, r, Lsub, omega )
...
spectral_therm_conductivity_xx = -1.*(1/(A_x))*dTheta_dT*summation_x;%Livia removed 1/(2*pi)
...
spectral_therm_conductivity = [spectral_therm_conductivity_xx]; %for the nanowire, we are only interested in the x-component
spectral_therm_conductivity_Lindsay = [spectral_therm_conductivity_x]; %for the nanowire, we are only interested in the x-component
