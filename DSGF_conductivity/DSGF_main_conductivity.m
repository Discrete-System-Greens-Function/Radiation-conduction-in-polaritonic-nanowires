...
function [] = DSGF_main_conductivity(description, discretization, material, T, T_conductance, epsilon_ref, omega, wave_type, output, discretization_type, L_char, delta_V, d, N_cross_section)
...
elseif strcmp('user_defined',discretization_type)
    ...
    %N_cross_section = 32;%32;%12;%52;%;%12;
     Nmin_SiC_1 = 1;
     Nmax_SiC_1 = N/2;
     Nmin_SiC_2 = (N/2)+1;
     Nmax_SiC_2 = N;
...
switch (material)
    ...
    case Material.Au %Added by Livia on 2025/07/29

	    %epsilon = Au_dielectric_function(omega); % (N_omega x 1) vector of all dielectric functions for every frequency

    %case {Material.SiC,Material.Au} %Added by Livia on 2025/07/29  
