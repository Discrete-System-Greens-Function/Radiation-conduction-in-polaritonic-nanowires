function [ spectral_therm_conductivity ] = spectral_therm_conductivity_function_coating( Trans, T_therm_cond, r, Lsub, omega, Nmin_SiC_1, Nmin_SiC_2, Nmax_SiC_1, Nmax_SiC_2, N_cross_section )
...
%spectral_therm_conductivity_xx = [spectral_therm_conductivity_xx]; %for the nanowire, we are only interested in the x-component
